...
const VoiceRecognitionGame = (props: Props): JSX.Element => {
	...
	const gameInstructions = "Para completar el ejercicio, presioná el botón de micrófono y leé en voz alta la palabra. Luego, presioná nuevamente el botón de micrófono para detener y guardar la grabación. Después, usá el botón 'comprobar' para enviar tu grabación. Si querés escuchar lo que grabaste, usá el botón amarillo.";
