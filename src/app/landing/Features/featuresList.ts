const features = [
	{
		title: 'efectivo',
		description:
			'Combinación única de juegos silábico-fonéticos que le permite al jugador alcanzar la lectoescritura al cabo de cuarenta días mediante módulos diferenciados por su nivel de dificultad',
		imageAlt: 'feature efectivo',
		imageSrc: `${process.env.NEXT_PUBLIC_BASE_PATH}/img/features/feature-effective.svg`,
	},
	{
		title: 'divertido',
		description:
	...
	},
	{
		...
		imageSrc: `${process.env.NEXT_PUBLIC_BASE_PATH}/img/features/feature-custom.svg`,
	},
	{
		title: 'innovadora',
		description:
		...
		imageSrc: `${process.env.NEXT_PUBLIC_BASE_PATH}/img/features/feature-modern.svg`,
	},
];
