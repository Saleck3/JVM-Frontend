const faqs = [
	{
		title: '¿Qué es Lecti?',
		description:
			'Lecti es una aplicación de aprendizaje diseñada con juegos para chicos. Esta les permite desarrollar la lectoescritura mediante el recorrido por niveles. Cada uno de los cuales ha sido creado en base al método silábico-fonético, reconocido internacionalmente como el más efectivo a la hora de formar lectores y escritores.',
	},
	{
